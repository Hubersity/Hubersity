from sqlalchemy import Table, ForeignKey, Column, Integer, String, TIMESTAMP, text, Text
...
forum_tags = Table(
    "forum_tags",
    Base.metadata,
    Column("forum_id", Integer, ForeignKey("forum.id"), primary_key=True),
...
class Post(Base):
    ...
    tags = relationship("PostTag", secondary=post_post_tags, back_populates="posts")
