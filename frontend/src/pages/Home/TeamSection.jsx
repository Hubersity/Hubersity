...
export default function TeamSection() {
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-[1350px] px-6 md:px-8
            ...
            {PEOPLE.map((p, i) => {
              ...
              return (
                <button
                  ...
                  className={`
                    relative overflow-hidden rounded-[28px] transition-all duration-500 ease-out shadow-xl
                    ${isActive ? "flex-[2.2] ring-2 ring-green-500" : "flex-[1] ring-0"}
                  `}
                >
                  <img
                    src={p.img}
